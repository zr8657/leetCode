...
public class L_840_Magic_Squares_In_Grid {

	public static void main(String[] arg0) {
		int grid[][] = { { 4, 3, 8, 4 }, { 9, 5, 1, 9 }, { 2, 7, 6, 2 } };
		L_840_Magic_Squares_In_Grid inc = new L_840_Magic_Squares_In_Grid();
		System.out.println(inc.numMagicSquaresInside(grid));
	}
